...
export function makeTimberRoofTemplate() {
  ...
  return [
    ...
    { id: ids.chkHane, type: 'custom_calc', data: {
      ...
      version: 2, subst: true,
      lines: [
        '# Materialeparametre — C24 (DS/EN 338)',
        'f_t0k = 14 MPa | karakteristisk trækstyrke, C24',
        'gamma_M = 1,35 | partialkoefficient, konstruktionstræ (DS/EN 1995-1-1 DK NA)',
        'k_mod = 0,9 | anvendelsesklasse 2, korttidslast (sne)',
        'f_t0d = k_mod·f_t0k/gamma_M → MPa',
        '# Tværsnit',
        'b = 45 mm | bredde',
        'h = 95 mm | højde',
        'N_tRd = f_t0d·b·h → kN',
        '# Påvirkning fra rammeberegningen (element 5)',
        'N_Ed = … kN | største trækkraft i hanebåndet',
        'N_Ed ≤ N_tRd | Træk parallelt med fibrene, §6.1.2',
      ],
      _result: null,
    }},
