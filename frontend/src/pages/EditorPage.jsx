...
function makeA1Template() {
  ...
  return [
    ...
    { id: id++, type: 'table', data: {
      ...
      has_header: true,
      rows: [
        ['Nr.', 'Bygningsanvendelse', 'Spandv. CC1 [m]', 'Spandv. CC2 [m]', 'Hojde o.t. CC1 [m]', 'Hojde o.t. CC2 [m]', 'Hojde u.t. CC1 [m]', 'Hojde u.t. CC2 [m]', 'Etager CC1', 'Etager CC2'],
        ['1',  'Laengere ophold: beboelse, kontor, hotel, dag-/doegninstitution, undervisning, klinik', '*',  '16',  '*',  '12', '*',  '6',  '*',  '5'],
        ['2',  'Hospital',                                                                               '*',  '16',  '*',  '--', '*',  '6',  '*',  '2'],
        ['3',  'Forsamling <=150 pers.: koncert, sport, kirke, auditorium, udstilling, teater, detailhandel, overdaekninger', '*', '16', '*', '12', '*', '6', '*', '2'],
        ['4',  'Forsamling >150 pers. (samme typer som nr. 3)',                                          '*',  '12',  '*',  '6',  '*',  '*',  '*',  '1'],
        ['5',  'Forsamling, tribuner >150 pers.',                                                        '--', '8',   '*',  '8',  '*',  '6',  '*',  '*'],
        ['6',  'Forsamling, overdaekninger og scener >150 pers.',                                        '--', '12',  '*',  '16', '--', '--', '*',  '*'],
        ['7',  'Industri: sundhedsskadelige kemikalier — saerligt store konsekvenser',                   '*',  '--',  '*',  '*',  '*',  '*',  '*',  '*'],
        ['8',  'Industri: meget store konsekvenser (forurenende, samfundsmaessig bet. arkiver)',          '*',  '--',  '*',  '*',  '*',  '*',  '*',  '*'],
        ['9',  'Industri: kraftvarme, visse bygninger til vareproduktion — andre konsekvenser',           '*',  '40',  '*',  '12', '*',  '6',  '*',  '*'],
        ['10', 'Industri/lager med ophold for fa personer: landbrug, vaeksthuse, siloanlæg',             '40', '*',   '20', '30', '3',  '6',  '*',  '*'],
        ['11', 'Dyrehold med arbejdspladser',                                                            '20', '40',  '12', '16', '3',  '6',  '*',  '*'],
        ['12', 'Parkeringsanlaeg',                                                                       '6',  '18',  '--', '20', '*',  '6',  '1',  '6'],
